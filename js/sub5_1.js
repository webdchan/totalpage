$(document).ready(function(){
  ...
  /* 지도 */
  $(".content>ul>li iframe").mouseenter(function(){ 
    $(".content>ul>li span").css({transform:"scale(2)", color:"red"}).fadeOut('100');
  });

  $(".content>ul>li iframe").mouseleave(function(){ 
    $(".content>ul>li span").css({transform:"scale(1)",color:"rgb(231, 235, 28)"}).fadeIn('100');
  });

  $(".content>ul>li span").mouseenter(function(){ 
    $(this).css({transform:"scale(2)",color:"red"}).fadeOut('100');
  });
